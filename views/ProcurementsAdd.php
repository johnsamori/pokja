...
loadjs.ready(['fprocurementsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fprocurementsadd", "x_item_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fprocurementsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fprocurementsadd", "x_supplier_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fprocurementsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fprocurementsadd", "x_user_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fprocurementsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fprocurementsadd", "x_created_at", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fprocurementsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fprocurementsadd", "x_updated_at", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
