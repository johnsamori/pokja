...
<?php } ?>
<script<?= Nonce() ?>>
loadjs.ready(['fsuppliersadd', 'jqueryinputmask'], function() {
	options = {
		'jitMasking': false,
		'removeMaskOnSubmit': true
	};
	ew.createjQueryInputMask("fsuppliersadd", "x_created_at", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fsuppliersadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fsuppliersadd", "x_updated_at", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<script>
loadjs.ready("head", function() { $("#fsuppliersadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script<?= Nonce() ?>>
