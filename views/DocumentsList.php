...
<?php if ($Page->procurement_id->Visible) { // procurement_id ?>
        <th data-name="procurement_id" class="<?= $Page->procurement_id->headerCellClass() ?>"><div id="elh_documents_procurement_id" class="documents_procurement_id"><?= $Page->renderFieldHeader($Page->procurement_id) ?></div></th>
<?php } ?>
<?php if ($Page->file_name->Visible) { // file_name ?>
        <th data-name="file_name" class="<?= $Page->file_name->headerCellClass() ?>"><div id="elh_documents_file_name" class="documents_file_name"><?= $Page->renderFieldHeader($Page->file_name) ?></div></th>
<?php } ?>
<?php if ($Page->file_path->Visible) { // file_path ?>
        <th data-name="file_path" class="<?= $Page->file_path->headerCellClass() ?>"><div id="elh_documents_file_path" class="documents_file_path"><?= $Page->renderFieldHeader($Page->file_path) ?></div></th>
<?php } ?>
<?php if ($Page->uploaded_at->Visible) { // uploaded_at ?>
        <th data-name="uploaded_at" class="<?= $Page->uploaded_at->headerCellClass() ?>"><div id="elh_documents_uploaded_at" class="documents_uploaded_at"><?= $Page->renderFieldHeader($Page->uploaded_at) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_documents_procurement_id" class="el_documents_procurement_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_documents_file_path" class="el_documents_file_path">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_documents_uploaded_at" class="el_documents_uploaded_at">
...
<?php if (!$Page->IsModal && !$Page->isExport()) { ?>
<script>
loadjs.ready(["wrapper", "head", "swal"],function(){$('#btn-action').on('click',function(){if(fdocumentsupdate.validateFields()){ew.prompt({title: ew.language.phrase("MessageEditConfirm"),icon:'question',showCancelButton:true},result=>{if(result) $("#fdocumentsupdate").submit();});return false;} else { ew.prompt({title: ew.language.phrase("MessageInvalidForm"), icon: 'warning', showCancelButton:false}); }});});
</script>
<?php } ?>
<?php if (!$Page->IsModal && !$Page->isExport()) { ?>
<script>
...
<script>
loadjs.ready(["wrapper", "head", "swal"],function(){$('.ew-grid-save, .ew-grid-insert').on('click',function(){ew.prompt({title: ew.language.phrase("MessageSaveGridConfirm"),icon:'question',showCancelButton:true},result=>{if(result) $("#fdocumentslist").submit();});return false;});});
</script>
<script>
loadjs.ready(["wrapper", "head", "swal"],function(){$('.ew-inline-update').on('click',function(){ew.prompt({title: ew.language.phrase("MessageSaveGridConfirm"),icon:'question',showCancelButton:true},result=>{if(result) $("#fdocumentslist").submit();});return false;});});
</script>
<script>
loadjs.ready(["wrapper", "head", "swal"],function(){$('.ew-inline-insert').on('click',function(){ew.prompt({title: ew.language.phrase("MessageSaveGridConfirm"),icon:'question',showCancelButton:true},result=>{if(result) $("#fdocumentslist").submit();});return false;});});
</script>
<script>
loadjs.ready(["wrapper", "head", "swal"],function(){var gridchange=false;$('[data-table="documents"]').change(function(){	gridchange=true;});$('.ew-grid-cancel,.ew-inline-cancel').click(function(){if (gridchange==true){ew.prompt({title: ew.language.phrase("ConfirmCancel"),icon:'question',showCancelButton:true},result=>{if(result) window.location = "<?php echo str_replace('_', '', 'documentslist'); ?>";});return false;}});});
</script>
<?php } ?>
<?php if (!$documents->isExport()) { ?>
<script>
loadjs.ready("jscookie", function() {
	...
	SearchToggle.on('click', function(event) { 
		...
		if (SearchToggle.hasClass('active')) { 
			Cookies.set("documents_searchpanel", "notactive", { path: '/', expires: expires }); 
		} else { 
			Cookies.set("documents_searchpanel", "active", { path: '/', expires: expires }); 
		} 
	});
});
</script>
