...
$sideMenu->addMenuItem(57, "mi_suppliers", $Language->menuPhrase("57", "MenuText"), "supplierslist", 49, substr("mi_suppliers", strpos("mi_suppliers", "mi_") + 3), AllowListMenu('{15F7FECB-EBDF-48AE-B272-3A5F7015D238}suppliers'), false, false, "fa-file", "", false, true);
