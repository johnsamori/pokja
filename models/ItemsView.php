...
class ItemsView extends Items
{
    ...
    // Page object name
    public string $PageObjName = "ItemsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "itemsview";
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("itemslist"); // Return to list page
                        return;
