...
class SuppliersEdit extends Suppliers
{
    ...
    // Page object name
    public string $PageObjName = "SuppliersEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "suppliersedit";
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'phone' before field var 'x_phone'
        $val = $this->hasFormValue("phone") ? $this->getFormValue("phone") : $this->getFormValue("x_phone");
    ...
    protected function editRow(): bool
    {
        ...
        if ($this->_email->CurrentValue != "") {
            $filterChk = "(`email` = '" . AdjustSql($this->_email->CurrentValue) . "')";
            ...
            if ($rsChk->fetchAssociative()) {
                $idxErrMsg = sprintf($this->language->phrase("DuplicateIndex"), $this->_email->CurrentValue, $this->_email->caption());
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // phone
        $this->phone->setDbValueDef($newRow, $this->phone->CurrentValue, $this->phone->ReadOnly);
