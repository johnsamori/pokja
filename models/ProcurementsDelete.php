 ...
 * Page class
 */
class ProcurementsDelete extends Procurements
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProcurementsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "procurementsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("procurementslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("procurementslist"); // Return to list
                return;
            }
        }
