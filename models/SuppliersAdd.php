...
class SuppliersAdd extends Suppliers
{
    ...
    // Page object name
    public string $PageObjName = "SuppliersAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "suppliersadd";
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->_email->CurrentValue != "") { // Check field with unique index
            $filter = "(`email` = '" . AdjustSql($this->_email->CurrentValue) . "')";
    ...
    protected function getAddRow(): array
    {
        ...
        // phone
        $this->phone->setDbValueDef($newRow, $this->phone->CurrentValue, false);
