...
class Items extends DbTable
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "items"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("itemslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "itemsview" => $this->language->phrase("View"),
            "itemsedit" => $this->language->phrase("Edit"),
            "itemsadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ItemsView",
            Config("API_ADD_ACTION") => "ItemsAdd",
            Config("API_EDIT_ACTION") => "ItemsEdit",
            Config("API_DELETE_ACTION") => "ItemsDelete",
            Config("API_LIST_ACTION") => "ItemsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("itemsdelete", $parm);
        }
    }
