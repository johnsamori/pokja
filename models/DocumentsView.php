...
class DocumentsView extends Documents
{
    ...
    // Page object name
    public string $PageObjName = "DocumentsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "documentsview";
