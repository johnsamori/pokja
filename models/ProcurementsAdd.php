 ...
 * Page class
 */
class ProcurementsAdd extends Procurements
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "ProcurementsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "procurementsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "procurementsview") {
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // item_id
        $this->item_id->setDbValueDef($newRow, $this->item_id->CurrentValue, false);

        // supplier_id
        $this->supplier_id->setDbValueDef($newRow, $this->supplier_id->CurrentValue, false);
        ...
        // procurement_date
        $this->procurement_date->setDbValueDef($newRow, UnFormatDateTime($this->procurement_date->CurrentValue, $this->procurement_date->formatPattern()), false);
