...
class SuppliersView extends Suppliers
{
    ...
    // Page object name
    public string $PageObjName = "SuppliersView";
    ...
    // CSS class/style
    public string $CurrentPageName = "suppliersview";
