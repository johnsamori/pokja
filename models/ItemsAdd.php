...
class ItemsAdd extends Items
{
    ...
    // Page object name
    public string $PageObjName = "ItemsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "itemsadd";
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'unit' before field var 'x_unit'
        $val = $this->hasFormValue("unit") ? $this->getFormValue("unit") : $this->getFormValue("x_unit");
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->unit->Visible && $this->unit->Required) {
                if (!$this->unit->IsDetailKey && IsEmpty($this->unit->FormValue)) {
    ...
    protected function getAddRow(): array
    {
        ...
        // unit
        $this->unit->setDbValueDef($newRow, $this->unit->CurrentValue, false);
        ...
        $this->_userid->setDbValueDef($newRow, $this->_userid->CurrentValue, false);
