...
class Suppliers extends DbTable
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "suppliers"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("supplierslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "suppliersview" => $this->language->phrase("View"),
            "suppliersedit" => $this->language->phrase("Edit"),
            "suppliersadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
