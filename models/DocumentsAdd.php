...
class DocumentsAdd extends Documents
{
    ...
    // Page object name
    public string $PageObjName = "DocumentsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "documentsadd";
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // uploaded_at
        $this->uploaded_at->setDbValueDef($newRow, UnFormatDateTime($this->uploaded_at->CurrentValue, $this->uploaded_at->formatPattern()), false);
        return $newRow;
    }
