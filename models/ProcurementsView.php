 ...
 * Page class
 */
class ProcurementsView extends Procurements
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProcurementsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "procurementsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "procurementslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "procurementslist"; // No matching record, return to list
                    } else {
